	...
	<view class="bg-white padding">
		<view class="grid margin-bottom text-center col-1"  >
			<view  class="bg-white margin-bottom">
				<image src="../../static/images/zichanchuzhi.png"></image>
			</view>
			<view  class="bg-white margin-bottom" style="font-weight: bold;font-size: 40rpx;">
				
				 在征得您的同意时，我们可以为金融机构、企业、业主等广大合作伙伴提供不良资产的出售、处置等服务。
			</view>
			<view  class="bg-white margin-bottom">
